...
const About = () => {
  return (
    <div id='about' className='my-32 mx-48 p-8 flex'>
      ...
      <div className='about-card w-1/2 flex flex-col justify-center items-center gap-3'>
        ...
        <ul className="flex flex-wrap w-2/3 m-auto justify-around md:text-2xl lg:text-3xl xl:text-4xl text-xl text-info text-opacity-60">
