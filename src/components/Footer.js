  ...
  return (
    <section className='pb-3 pt-48 flex bg-footer flex flex-wrap '>
        ...
        <div className='flex justify-center gap-6 py-4 xl:w-1/2'>
          <a href='https://twitter.com/sashamdesigns' target="_blank" rel="noopener noreferrer" className='text-4xl text-base-100'><FaTwitter /></a>
          <a href='https://github.com/sashamars33' target="_blank" rel="noopener noreferrer" className='text-4xl text-base-100'><FaGithub /></a>
          <a href='https://www.linkedin.com/in/-sasha-marshall/' target="_blank" rel="noopener noreferrer" className='text-4xl text-base-100'><FaLinkedin /></a>
          <a href='mailto:sashamarshalldesigns@gmail.com' target="_blank" rel="noopener noreferrer" className='text-4xl text-base-100'><FaRegEnvelope /></a>
          <a href='https://www.instagram.com/sashamarshall_33/' target="_blank" rel="noopener noreferrer" className='text-4xl text-base-100'><FaInstagram /></a>
        </div>
