...
const Footer = () => {
  return (
    <section className='pb-3 pt-48 flex bg-footer flex flex-wrap'>
        <div className='flex flex-wrap justify-between w-full items-center mx-48'>
        <div className='flex w-full justify-start gap-12 py-4 w-1/2'>
          ...
          <a href='https://www.instagram.com/sashamarshall_33/' className='text-4xl text-base-100'><FaInstagram /></a>
            ...
            <div className='flex justify-end text-2xl uppercase text-base-100 gap-6 w-1/2'>
